...
public class Twitter extends Controller{
	...
	static final ConsumerKey KEY = new ConsumerKey("vkibbrE9Lf0VQypETuc4RFrSP", "NvY1aoGC19eMOBzBDxnckN9xU5stXDDG7iQop76gE0X0yu2v8X");

    private static final ServiceInfo SERVICE_INFO = new ServiceInfo("https://api.twitter.com/oauth/request_token","https://api.twitter.com/oauth/access_token","https://api.twitter.com/oauth/authorize",KEY);
    ...
    public Result auth() {
        ...
        if (Strings.isNullOrEmpty(verifier)) {
            ...
            return redirect(controllers.routes.Twitter.homeTimeline());
        }
    }
